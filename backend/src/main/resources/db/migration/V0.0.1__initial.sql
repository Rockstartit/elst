...
create table building_block_properties (building_block_id binary(16) not null, building_block_version_number bigint not null, display_name varchar(255), `key` varchar(255), `order` integer) engine=InnoDB;
create table building_blocks (building_block_id binary(16) not null, building_block_version_number bigint not null, description varchar(255), name varchar(50) not null, release_status tinyint, primary key (building_block_id, building_block_version_number)) engine=InnoDB;
...
create table page_building_blocks (page_building_block_id binary(16) not null, building_block_id binary(16) not null, building_block_version_number bigint not null, page_id binary(16) not null, primary key (page_building_block_id)) engine=InnoDB;
...
create table readme (building_block_id binary(16) not null, building_block_version_number bigint not null, content tinyblob, primary key (building_block_id, building_block_version_number)) engine=InnoDB;
...
alter table building_block_properties add constraint FKsa46ycrttslf80o4rxs1pfiy3 foreign key (building_block_id, building_block_version_number) references building_blocks (building_block_id, building_block_version_number);
