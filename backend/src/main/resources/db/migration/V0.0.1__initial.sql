...
create table course_unit_learning_goals (course_unit_id binary(16) not null, value varchar(255)) engine=InnoDB;
...
alter table course_unit_learning_goals add constraint FK2ij27ykk48c04l4ixvydf128o foreign key (course_unit_id) references course_units (course_unit_id);
