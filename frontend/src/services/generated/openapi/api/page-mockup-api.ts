...
/**
 * PageMockupApi - axios parameter creator
 * @export
 */
export const PageMockupApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
        ...
        deleteMockup: async (mockupId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/page-mockups/{mockupId}`
...
/**
 * PageMockupApi - functional programming interface
 * @export
 */
export const PageMockupApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = PageMockupApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Delete mockup
        ...
        async deleteMockup(mockupId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['PageMockupApi.deleteMockup']?.[localVarOperationServerIndex]?.url;
        ...
        async editMockup(mockupId: string, editMockupRequest: EditMockupRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['PageMockupApi.editMockup']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async uploadMockup(pageId: string, description?: string, fileName?: File, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['PageMockupApi.uploadMockup']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * PageMockupApi - factory interface
 * @export
 */
export const PageMockupApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = PageMockupApiFp(configuration)
    return {
        /**
         * 
         * @summary Delete mockup
...
/**
 * PageMockupApi - object-oriented interface
 * @export
 * @class PageMockupApi
 * @extends {BaseAPI}
 */
export class PageMockupApi extends BaseAPI {
    /**
     * 
     * @summary Delete mockup
     * @param {string} mockupId Id of mockup
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof PageMockupApi
     */
    public deleteMockup(mockupId: string, options?: RawAxiosRequestConfig) {
        return PageMockupApiFp(this.configuration).deleteMockup(mockupId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public editMockup(mockupId: string, editMockupRequest: EditMockupRequest, options?: RawAxiosRequestConfig) {
        return PageMockupApiFp(this.configuration).editMockup(mockupId, editMockupRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public uploadMockup(pageId: string, description?: string, fileName?: File, options?: RawAxiosRequestConfig) {
        return PageMockupApiFp(this.configuration).uploadMockup(pageId, description, fileName, options).then((request) => request(this.axios, this.basePath));
    }
}
